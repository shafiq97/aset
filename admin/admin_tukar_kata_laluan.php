...
if (isset($_POST['simpan'])) {
  ...
  $sql = "select kata_laluan_a from admin where id_admin = '$admin_id' and kata_laluan_a = '$password_old'";

  $result = $conn->query($sql);

  if ($result->num_rows > 0) {
    $sql = "update admin set kata_laluan_a = '$password_new' where id_admin = '$admin_id'";
    
    $receiver = $_SESSION['email_admin'];
    if ($conn->query($sql) === TRUE) {
      ...
      if (!$mail->Send()) {
        ...
        // echo "Email sent successfully";å
