...
if ($result->num_rows > 0) {
  ...
  ?>
  <script>
    alert("Wrong credentials or account not activate");
  ...
  <div class="content_profile">
    <form method="POST" action="update_admin.php">
      ...
      <div class="form-group mb-3">
        ...
        <input type="email" name="email" class="form-control" id="student_email" placeholder="Sila masukkan email" value="<?php echo $email ?>" disabled>
      </div>
      <!-- Nama Pelajar -->
      <div class="form-group mb-3">
        <label for="student_name">Nama</label>
        <input type="text" name="name" class="form-control" id="student_name" placeholder="Sila masukkan nama" value="<?php echo $name ?>" disabled>
      </div>
      <div class="form-group mb-3">
      ...
      <div class="form-group mb-3">
        ...
        <input type="text" name="no_telefon_a" class="form-control" id="no_telefon_a" placeholder="Sila masukkan no telefon" value="<?php echo $_SESSION['no_telefon_a'] ?>">
      </div>
