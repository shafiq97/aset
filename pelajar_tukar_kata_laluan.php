...
<body>
  ...
  <?php require 'student/student_sidenav.php' ?>
  <script>
  ...
  <div class="content_profile">
    <form method="POST">
      <input type="hidden" name="no_matrik" value="<?php echo $_SESSION['no_matrik'] ?>">
...
if (isset($_POST['simpan'])) {
  ...
  $sql = "select kata_laluan_p from pelajar where no_matrik = '$no_matrik' and kata_laluan_p = '$password_old'";

  $result = $conn->query($sql);

  if ($result->num_rows > 0) {
    $sql = "update pelajar set kata_laluan_p = '$password_new' where no_matrik = '$no_matrik'";
    
    $receiver = $_SESSION['email_pelajar'];
