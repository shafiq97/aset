...
$sql = "select count(*) as bilangan from akuan where kerusi_status = 'kurang'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
...
<body>
  ...
  <div class="content">
    ...
    <table id="example" class="display table" style="width:100%">
      ...
      <tbody>
        <?php
        $sql = "SELECT * from akuan inner join pelajar on akuan.no_matrik = pelajar.no_matrik where kerusi_status = 'kurang'";
