...
<body>
  ...
  <div class="content">
    <table id="example" class="display nowrap" style="width:100%">
      ...
      <tbody>
        <?php
        $sql = "SELECT * FROM pelajar where kkp = '$penyelia_kkp'";
        ...
        ?>
            <tr>
              ...
              if ($row['status'] == 0) {
              ?>
                <td><a href="update_student_status.php?activate=<?php echo $row['no_matrik'] ?>" class="btn btn-success btn-block">Activate</a></td>
              <?php
              } else {
              ?>
                <td><a href="update_student_status.php?deactivate=<?php echo $row['no_matrik'] ?>" class="btn btn-warning btn-block">Deactivate</a></td>
              <?php
              }
              ?>
              <td><a onclick="return confirm('Anda pasti untuk memadam rekod?')" class="btn btn-danger btn-block" href="delete.php?student_id=<?php echo $row['no_matrik'] ?>">Delete</a></td>
            </tr>
        <?php
          }
        }
