...
<body>
  ...
  <div class="content">
    <table id="example" class="display table" style="width:100%">
      ...
      <tbody>
        <?php
        $sql = "SELECT *, akuan.status as akuanstatus FROM AKUAN inner join pelajar on akuan.no_matrik = pelajar.no_matrik where akuan.kkp = '$penyelia_kkp' and jenis_borang = 'pemulangan'";
        ...
        ?>
            <tr>
              ...
              <?php
              if ($row['akuanstatus'] == 0 && $row['jenis_borang'] == 'pemulangan') {
              ?>
                <td>Belum Disemak</td>
              <?php
              } else if ($row['akuanstatus'] == 1 && $row['jenis_borang'] == 'pemulangan') {
              ?>
                <td>Telah disemak</td>
              <?php
              }
