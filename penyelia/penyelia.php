  ...
  <div class="content">
    <form method="POST" action="update_profile_penyelia.php">
      ...
      <div class="form-group mb-3">
        ...
        <input disabled type="text" name="no_telefon_s" class="form-control" id="no_telefon_s" placeholder="Sila masukkan no telefon" value="<?php echo $_SESSION['no_telefon_s'] ?>">
      </div>
    </form>
  </div>
  </div>
