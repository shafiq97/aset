...
<body>
  ...
  <div class="content">
    <h3>Senarai Pelajar Tidak Hantar Borang Pemulangan</h3>
    <table id="example" class="display table" style="width:100%">
      ...
      <tbody>
        <?php
        $sql = "select distinct pelajar.nama_pelajar, pelajar.email_pelajar, pelajar.no_telefon_p from pelajar inner join akuan where pelajar.no_matrik not in (select akuan.no_matrik from akuan) and pelajar.kkp = '$_SESSION[kkp]' and pelajar.status=1";
