...
<body>
  ...
  <div class="content_profile">
    <form method="POST">
      <input type="hidden" name="staff_id" value="<?php echo $_SESSION['id_staff'] ?>">
...
if (isset($_POST['simpan'])) {
  ...
  $sql = "select kata_laluan_s from penyelia where id_staff = '$staff_id' and kata_laluan_s = '$password_old'";

  $result = $conn->query($sql);

  if ($result->num_rows > 0) {
    $sql = "update penyelia set kata_laluan_s = '$password_new' where id_staff = '$staff_id'";
    
    $receiver = $_SESSION['email_staff'];
