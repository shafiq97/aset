...
<body>
  ...
  <div class="dropdown-container">
    <a href="paparan.php">
          <span class="links_name">Paparan pelajar</span>
        </a>
  </div>
  ...
  <div class="dropdown-container">
    <a href="penerimaan_ppas.html">
          <span class="links_name">Penerimaan aset</span>
        </a>
    <a href="pemulangan_ppas.html">
      ...
      <div class="center">
        <div class="profile">
          <div class="profile-info">
            ...
            <div class="details">
              <h2 class="name"><?php echo $_SESSION['nama_ppas'] ?></h2>
              <span class="desc"><?php echo $_SESSION['id_ppas'] ?></span>
              <span class="desc"><?php echo $_SESSION['email_ppas'] ?></span>
              <span class="desc"><?php echo $_SESSION['no_telefon_ppas'] ?></span>
            </div>
          </div>
        </div>
      </div>
