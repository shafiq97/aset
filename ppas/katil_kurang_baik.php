...
require "../conn.php";
session_start();
$sql = "select KKP from ppas where id_staff = '$_SESSION[id_ppas]'";
...
$sql = "select count(*) as bilangan from akuan where kerusi_status = 'kurang' and jenis_borang = 'penerimaan'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
...
<body>
  ...
  <div class="content">
    <h3>Kerusi Status Kurang Baik: <?php echo $kerusi_ada ?></h3>
    <table id="example" class="display table" style="width:100%">
      ...
      <tbody>
        <?php
        $sql = "SELECT * from akuan inner join pelajar on akuan.no_matrik = pelajar.no_matrik where kerusi_status = 'kurang' and akuan.kkp = '$_SESSION[kkp]' and jenis_borang = 'penerimaan' ";
