...
<body>
  ...
  <div class="content">
    <table id="example" class="display table" style="width:100%">
      ...
      <tbody>
        <?php
        $sql = "SELECT *, akuan.disahkan as akuansah FROM AKUAN inner join pelajar on akuan.no_matrik = pelajar.no_matrik where akuan.kkp = '$ppas_kkp' and jenis_borang = 'pemulangan'";
