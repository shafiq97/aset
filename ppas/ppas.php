  ...
  <div class="content">
    <form method="POST" action="update_profile_ppas.php">
      ...
      <div class="form-group mb-3">
        ...
        <input disabled type="text" name="no_telefon_ppas" class="form-control" id="no_telefon_ppas" placeholder="Sila masukkan no telefon" value="<?php echo $_SESSION['no_telefon_ppas'] ?>">
      </div>
    </form>
  </div>
  </div>
