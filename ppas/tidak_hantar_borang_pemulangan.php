...
<body>
  ...
  <div class="content">
    ...
    <table id="example" class="display table" style="width:100%">
      ...
      <tbody>
        <?php
        $sql = "select distinct pelajar.nama_pelajar, pelajar.email_pelajar, pelajar.no_telefon_p from pelajar inner join akuan where akuan.jenis_borang!='pemulangan' and pelajar.kkp = '$_SESSION[kkp]' and pelajar.status=1";
