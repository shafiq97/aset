...
$sql = "select count(*) as bilangan from akuan where tilam_status = 'ada'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
...
<body>
  ...
  <div class="content">
    <h3>Tilam Status Ada: <?php echo $tilam_ada ?></h3>
    <table id="example" class="display table" style="width:100%">
      ...
      <tbody>
        <?php
        $sql = "SELECT * from akuan inner join pelajar on akuan.no_matrik = pelajar.no_matrik where tilam_status = 'ada'";
    ...
    <h3>Tilam Status Tiada: <?php echo $tilam_tiada ?></h3>
    <table id="example2" class="display table" style="width:100%; margin-top:10px">
      ...
      <tbody>
        <?php
        $sql = "SELECT * from akuan inner join pelajar on akuan.no_matrik = pelajar.no_matrik where tilam_status = 'tiada'";
