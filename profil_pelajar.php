  ...
  <div class="content_profile">
    <form method="POST" action="update_profile_pelajar.php">
      ...
      <div class="form-group mb-3">
        ...
        <input type="text" name="sem" class="form-control" id="student_sem" placeholder="Sila masukkan no matrik" value="<?php echo $_SESSION['sem_no'] ?>">
      </div>
      <!-- Tahun -->
      <div class="form-group mb-3">
        <label for="tahun">Tahun</label>
        <input type="text" name="tahun" class="form-control" id="tahun" placeholder="Sila masukkan tahun" value="<?php echo $_SESSION['tahun'] ?>">
      </div>
      <!-- Sem -->
      <div class="form-group mb-3">
        <label for="no_telefon_p">No telefon</label>
        <input type="text" name="no_telefon_p" class="form-control" id="no_telefon_p" placeholder="Sila masukkan no telefon" value="<?php echo $_SESSION['no_telefon_p'] ?>">
      </div>
